...
def main():
    ...
    for key in mentorDict:
        ...
        for menteeArray in menteeWaitlistValues:
            ...
            #print(menteeArray[18]+' '+mentorArray[18])
            ...
            matchArray.append([str(matchScore),mentorArray[0],mentorArray[3],mentorArray[1],mentorArray[2],mentorArray[5],menteeArray[0],menteeArray[3],menteeArray[1],menteeArray[2],menteeArray[5]])
